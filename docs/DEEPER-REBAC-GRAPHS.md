...
Read this only after the three short sessions in the README. Each section is a
...
A `view` permission can allow either path. The evaluator tries its rules one at
